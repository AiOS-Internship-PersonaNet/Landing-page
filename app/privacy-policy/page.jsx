...
export default function PrivacyPolicy() {
    ...
    <div className='pb-6'>
      ...
      <div className="container">
        ...
        <p>
          Last updated: Dec 23, 2024 This Privacy Policy describes Our policies
        ...
        <p>
          ...
          directors or other managing authority. Business, for the purpose of
          ...
          California. CCPA and/or CPRA refers to the California Consumer Privacy
          Act (the "CCPA") as amended by the California Privacy Rights Act of
          2020 (the "CPRA"). Company (referred to as either "the Company", "We",
          "Us" or "Our" in this Agreement) refers to SuperINTRO, Inc, 528 Larkin
          St Ste 300. For the purpose of the GDPR, the Company is the Data
          Controller. Consumer, for the purpose of the CCPA/CPRA, means a
          ...
          uses. Country refers to: Arizona, United States Data Controller, for
          the purposes of the GDPR (General Data Protection Regulation), refers
          to the Company as the legal person which alone or jointly with others
          determines the purposes and means of the processing of Personal Data.
          Device means any device that can access the Service such as a
          computer, a cellphone or a digital tablet. Do Not Track (DNT) is a
          ...
          websites. GDPR refers to EU General Data Protection Regulation.
          Personal Data is any information that relates to an identified or
          identifiable individual. For the purposes of GDPR, Personal Data means
          any information relating to You such as a name, an identification
          ...
          cultural or social identity. For the purposes of the CCPA/CPRA,
          ...
          be linked, directly or indirectly, with You. Service refers to the
          ...
          Providers are considered Data Processors. Third-party Social Media
          ...
          example, the duration of a page visit). Website refers to SuperINTRO,
          accessible from https://www.SuperINTRO You means the individual
          ...
          as applicable. Under GDPR, You can be referred to as the Data Subject
        ...
        <p>
          ...
          requests: To attend and manage Your requests to Us. To deliver
          targeted advertising to You: We may use Your information to develop
          and display content and advertising (and work with third-party vendors
          who do so) tailored to Your interests and/or location and to measure
          its effectiveness. For business transfers: We may use Your information
          ...
          Providers to monitor and analyze the use of our Service, to advertise
          on third party websites to You after You visited our Service, for
          payment processing, to contact You. For business transfers: We may
        ...
        <p>
          ...
          Personal Data Service may give you the ability to delete certain
          information about You from within the Service. You may update, amend,
          or delete Your information at any time by signing in to Your Account,
          if you have one, and visiting the account settings section that allows
        ...
        <p>
          ...
          Request Metrics Their Privacy Policy can be viewed at
          https://requestmetrics.com/privacy/
        </p>
        {/* Email Marketing */}
        ...
        <p>
          ...
          instructions provided in any email We send or by contacting Us. We may
          use Email Marketing Service Providers to manage and send emails to
          You. Sendgrid Their Privacy Policy can be viewed at
        ...
        <p>
          ...
          secure handling of payment information. Apple Store In-App Payments
          Their Privacy Policy can be viewed at
          https://www.apple.com/legal/privacy/en-ww/ Google Play In-App Payments
          Their Privacy Policy can be viewed at
          https://www.google.com/policies/privacy/ Stripe Their Privacy Policy
          can be viewed at https://stripe.com/us/privacy PayPal Their Privacy
        ...
        <p>
          ...
          are likely to be more interests to you. These third party vendors
          collect, store, use, process, and transfer . information about Your
          activity on Our Service in accordance with their Privacy Policies and
          to enable Us to: Measure and analyze traffic and browsing activity on
          Our Service Show advertisements for our products and/or services to
          You on third-party websites or apps Measure and analyze the
          performance of Our advertising campaigns Some of these third-party
          vendors may use non-cookie technologies that may not be impacted by
          browser settings that block cookies. Your browser may not permit You
          to block such technologies. You can use the following third-party
          tools to decline the collection and use of information for the purpose
          of serving You interest-based advertising: The NAI's opt-out platform:
          http://www.networkadvertising.org/choices/ The EDAA's opt-out platform
          http://www.youronlinechoices.com/ The DAA's opt-out platform:
          http://optout.aboutads.info/?c=2&lang=EN You may opt-out of all
          personalized advertising by enabling privacy features on Your mobile
          device such as Limit Ad Tracking (iOS) and Opt Out of Ads
          Personalization (Android). See Your mobile device Help system for more
          information. We may share information, such as hashed email addresses
          (if available) or other online identifiers collected on Our Service
          ...
          each vendor listed below. The third-party vendors We use are: Google
          ...
          https://policies.google.com/privacy Bing Ads Remarketing Bing Ads
          remarketing service is provided by Microsoft Inc. You can opt-out of
          ...
          https://support.twitter.com/articles/20170405 You can learn more about
          the privacy practices and policies of Twitter by visiting their
          Privacy Policy page: https://twitter.com/privacy Facebook Facebook
          ...
          https://www.facebook.com/help/516147308587266 To opt-out from
        ...
        <h1>GDPR Privacy</h1>
        <p>
          Legal Basis for Processing Personal Data under GDPR We may process
          Personal Data under the following conditions: Consent: You have given
          Your consent for processing Personal Data for one or more specific
          purposes. Performance of a contract: Provision of Personal Data is
          necessary for the performance of an agreement with You and/or for any
          pre-contractual obligations thereof. Legal obligations: Processing
          Personal Data is necessary for compliance with a legal obligation to
          which the Company is subject. Vital interests: Processing Personal
          Data is necessary in order to protect Your vital interests or of
          another natural person. Public interests: Processing Personal Data is
          related to a task that is carried out in the public interest or in the
          exercise of official authority vested in the Company. Legitimate
          interests: Processing Personal Data is necessary for the purposes of
          the legitimate interests pursued by the Company. In any case, the
          Company will gladly help to clarify the specific legal basis that
        ...
        <h1>Your Rights under the GDPR</h1>
        <p>
          ...
          hold about You corrected. Object to processing of Your Personal Data.
          ...
          purposes. Request erasure of Your Personal Data. You have the right to
          ask Us to delete or remove Personal Data when there is no good reason
          for Us to continue processing it. Request the transfer of Your
          Personal Data. We will provide to You, or to a third- party You have
        ...
        <h1>Exercising of Your GDPR Data Protection Rights</h1>
        <p>
        ...
        <p>
          ...
          Categories of Personal Information Collected We collect information
          that identifies, relates to, describes, references, is capable of
          being associated with, or could reasonably be linked, directly or
          indirectly, with a particular Consumer or Device. The following is a
          list of categories of personal information which we may collect or may
          have been collected from California residents within the last twelve
          (12) months. Please note that the categories and examples provided in
          the list below are those defined in the CCPA/CPRA. This does not mean
          that all examples of that category of personal information were in
          fact collected by Us, but reflects our good faith belief to the best
          ...
          provided such personal information directly to Us. Category A:
          Identifiers. Examples: A real name, alias, postal address, unique
          personal identifier, online identifier, Internet Protocol address,
          email address, account name, driver's license number, passport number,
          or other similar identifiers. Collected: Yes. Category B: Personal
          information categories listed in the California Customer Records
          statute (Cal. Civ. Code § 1798.80(e)). Examples: A name, signature,
          ...
          categories. Collected: Yes. Category C: Protected classification
          characteristics under California or federal law. Examples: Age (40
          ...
          (including familial genetic information). Collected: No. Category D:
          Commercial information. Examples: Records and history of products or
          services purchased or considered. Collected: Yes. Category E:
          Biometric information. Examples: Genetic, physiological, behavioral,
          ...
          exercise data. Collected: No. Category F: Internet or other similar
          network activity. Examples: Interaction with our Service or
          advertisement. Collected: Yes. Category G: Geolocation data. Examples:
          Approximate physical location. Collected: No. Category H: Sensory
          data. Examples: Audio, electronic, visual, thermal, olfactory, or
          similar information. Collected: No. Category I: Professional or
          employment-related information. Examples: Current or past job history
          or performance evaluations. Collected: No. Category J: Non-public
          education information (per the Family Educational Rights and Privacy
          Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)). Examples: Education
          ...
          Collected: No. Category K: Inferences drawn from other personal
          information. Examples: Profile reflecting a person's preferences,
          characteristics, psychological trends, predispositions, behavior,
          attitudes, intelligence, abilities, and aptitudes. Collected: No.
          Category L: Sensitive personal information. Examples: Account login
          and password information, geolocation data. Collected: Yes. Under
          CCPA/CPRA, personal information does not include: Publicly available
          information from government records Deidentified or aggregated
          consumer information Information excluded from the CCPA/CPRA's scope,
          ...
          data Personal Information covered by certain sector-specific privacy
        ...
        <h1>Sources of Personal Information</h1>
        <p>
          We obtain the categories of personal information listed above from the
          following categories of sources: Directly from You. For example, from
          ...
          Service. Automatically from You. For example, through cookies We or
          our Service Providers set on Your Device as You navigate through our
          Service. From Service Providers. For example, third-party vendors to
        ...
        <p>
          ...
          which may include the following examples: To operate our Service and
          provide You with Our Service. To provide You with support and to
          respond to Your inquiries, including to investigate and address Your
          concerns and monitor and improve our Service. To fulfill or meet the
          reason You provided the information. For example, if You share Your
          contact information to ask a question about our Service, We will use
          that personal information to respond to Your inquiry. If You provide
          Your personal information to purchase a product or service, We will
          ...
          law, court order, or governmental regulations. As described to You
          when collecting Your personal information or as otherwise set forth in
          the CCPA/CPRA. For internal administrative and auditing purposes. To
          ...
          prosecute those responsible for such activities. Other one-time uses.
        ...
        <p>
          ...
          for business or commercial purposes: Category A: Identifiers Category
          B: Personal information categories listed in the California Customer
          Records statute (Cal. Civ. Code § 1798.80(e)) Category D: Commercial
          information Category F: Internet or other similar network activity
        ...
        <h1>Share of Personal Information</h1>
        <p>
          ...
          following categories of third parties: Service Providers Payment
          processors Our affiliates Our business partners Third party vendors to
        ...
        <h1>Sale of Personal Information</h1>
        <p>
          ...
          information, but not necessarily a monetary benefit. We do not sell
          personal information as the term sell is commonly understood. We do
          allow Service Providers to use Your personal information for the
          business purposes described in Our Privacy Policy, for activities such
          as advertising, marketing, and analytics, and these may be deemed a
          sale under CCPA/CPRA. We may sell and may have sold in the last twelve
          (12) months the following categories of personal information: Category
          A: Identifiers Category B: Personal information categories listed in
          the California Customer Records statute (Cal. Civ. Code § 1798.80(e))
          Category D: Commercial information Category E: Internet or similar
          network activity. defined in the CCPA/CPRA. This does not mean that
          all examples of that category of personal information were in fact
          sold, but reflects our good faith belief to the best of Our knowledge
        ...
        <h1>Sale of Personal Information of Minors Under 16 Years of Age</h1>
        <p>
          ...
          their permission. We do not sell the personal information of Consumers
          We actually know are less than 16 years of age, unless We receive
          ...
          representative) may submit a request to Us by contacting Us. If You
          have reason to believe that a child under the age of 13 (or 16) has
        ...
        <h1>Your Rights under the CCPA/CPRA</h1>
        <p>
          ...
          California, You have the following rights: The right to notice. You
          ...
          used. The right to know/access. Under CCPA/CPRA, You have the right to
          ...
          disclose to You: The categories of personal information We collected
          about You The categories of sources for the personal information We
          collected about You Our business or commercial purposes for collecting
          or selling that personal information The categories of third parties
          with whom We share that personal information The specific pieces of
          personal information We collected about You If we sold Your personal
          information or disclosed Your personal information for a business
          purpose, We will disclose to You: The categories of personal
          information categories sold The categories of personal information
          categories disclosed The right to say no to the sale or sharing of
          Personal Data (opt-out). You have the right to direct Us to not sell
          Your personal information. To submit an opt-out request, please see
          the "Do Not Sell My Personal Information" section or contact Us. The
          right to correct Personal Data. You have the right to correct or
          rectify any inaccurate personal information about You that We
          ...
          applies. The right to limit use and disclosure of sensitive Personal
          Data. You have the right to request to limit the use or disclosure of
          ...
          Us. The right to delete Personal Data. You have the right to request
          ...
          with You, or otherwise perform our contract with You. Detect security
          ...
          another right provided for by law. Comply with the California
          Electronic Communications Privacy Act (Cal. Penal Code § 1546 et.
          seq.). Engage in public or peer-reviewed scientific, historical, or
          ...
          achievement, if You previously provided informed consent. Enable
          ...
          obligation. Make other internal and lawful uses of that information
          that are compatible with the context in which You provided it. The
          ...
          including by: Denying goods or services to You Charging different
          prices or rates for goods or services, including the use of discounts
          or other benefits or imposing penalties Providing a different level or
          quality of goods or services to You Suggesting that You will receive a
          different price or rate for goods or services or a different level or
          quality of goods or services.
        </p>
        {/* Exercising Your CCPA/CPRA Data Protection Rights */}
        <h1>Exercising Your CCPA/CPRA Data Protection Rights</h1>
        <p>
          ...
          sensitive information collected. Additionally, in order to exercise
          any of Your rights under the CCPA/CPRA, and if You are a California
          resident, You can contact Us: By email: admin@flealyst.com Only You,
          or a person registered with the California Secretary of State that You
          authorize to act on Your behalf, may make a verifiable request related
          to Your personal information. Your request to Us must: Provide
          ...
          representative Describe Your request with sufficient detail that
          allows Us to properly understand, evaluate, and respond to it We
          cannot respond to Your request or provide You with the required
          information if We cannot: Verify Your identity or authority to make
          the request And confirm that the personal information relates to You
          ...
          that is readily usable and should allow You to transmit the
        ...
        <p>
          ...
          business purposes described in Our Privacy Policy, for activities such
          as advertising, marketing, and analytics, and these may be deemed a
          sale under CCPA/CPRA. You have the right to opt-out of the sale of
          Your personal information. Once We receive and confirm a verifiable
          consumer request from You, we will stop selling Your personal
          information. To exercise Your right to opt-out, please contact Us. The
          Service Providers we partner with (for example, our analytics or
        ...
        <p>
          ...
          Service. Additionally, You can opt out of receiving ads that are
          personalized as served by our Service Providers by following our
          instructions presented on the Service: The NAI's opt-out platform:
          http://www.networkadvertising.org/choices/ The EDAA's opt-out platform
          http://www.youronlinechoices.com/ The DAA's opt-out platform:
          http://optout.aboutads.info/?c=2&lang=EN The opt out will place a
          cookie on Your computer that is unique to the browser You use to opt
          out. If you change browsers or delete the cookies saved by Your
        ...
        <p>
          ...
          targeted to Your interests: "Opt out of Interest-Based Ads" or "Opt
          out of Ads Personalization" on Android devices "Limit Ad Tracking" on
          iOS devices You can also stop the collection of location information
          from Your mobile device by changing the preferences on Your mobile
          device.
        </p>
        {/* Limit the Use or Disclosure of My Sensitive Personal Information */}
        <h1>
        ...
        <p>
          ...
          or goods. We collect, use and disclose sensitive personal information
          in ways that are necessary to provide the Service. For more
          information on how We use Your personal information, please see the
        ...
        <p>
          ...
          marketing purposes. If you'd like to request more information under
          the California Shine the Light law, and if You are a California
