      ...
      <div className="container max-w-4xl py-12">
        <div className="space-y-6">
          ...
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="use-of-personal-data">
                ...
                <AccordionContent>
                  <div className="space-y-4">
                    ...
                    <h4 className="font-medium text-sm">Sharing Your Personal Information</h4>
                    <p>We may share Your personal information in the following situations:</p>
                    
                    <ul className="list-disc pl-6 space-y-2">
                      <li>
                        <strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to advertise on third party websites to You after You visited our Service, for payment processing, to contact You.
                      </li>
                      <li>
            ...
            <AccordionItem value="retention-of-personal-data">
            ...
            <AccordionItem value="transfer-of-personal-data">
            ...
            <AccordionItem value="delete-personal-data">
            ...
            <AccordionItem value="disclosure-of-personal-data">
              ...
              <AccordionItem value="analytics">
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <p>
                      We may use third-party Service providers to monitor and analyze the use of our Service. Google Analytics Google Analytics
                      is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected
                      to track and monitor the use of our Service. This data is shared with other Google services. Google may use the 
                      collected data to contextualize and personalize the ads of its own advertising network. You can opt-out of having
                      made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser 
                      add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js and dc.js) from sharing information
                      with Google Analytics about visits activity. For more information on the privacy practices of Google, please visit 
                      the Google Privacy & Terms web page: https://policies.google.com/privacy Request Metrics Their Privacy Policy can 
                      be viewed at https://requestmetrics.com/privacy/
              ...
              <AccordionItem value="email-marketing">
              ...
              <AccordionItem value="payments">
                ...
                <AccordionContent>
                <ul className="list-disc pl-6 space-y-2">
                  <h3 className="font-large font-bold"> Payment Processing </h3>
                    <p>
                    We may offer paid products and/or services within the Service. To facilitate payment processing, we use third-party services
                    (e.g. payment processors). We do not store or collect your payment card details. Instead, this information is provided 
                    directly to our third-party payment processors.
                    </p>
                  <h3 className="font-large font-bold"> Security Standards </h3>
                    <p>
                    Our payment processors adhere to the standards set by PCI-DSS (Payment Card Industry Data Security Standard), which is managed
                    by the PCI Security Standards Council. This ensures the secure handling of payment information.
                    </p>
                  <h3 className="font-large font-bold"> Third-Party Payment Processors </h3>
                    <p>  </p>
                    <span> We use the following third-party payment processors: </span>
                      <ul className="list-disc pl-6 space-y-2">
                        <li>  
                          <strong> Apple Store In-App Payments: </strong> 
                            <a href="https://www.apple.com/legal/privacy/en-ww/" target="_blank" className="text-blue-600 hover:underline">
                                Privacy Policy
                            </a> 
                        </li>
                        <li> 
                        ...
                        <li> 
                          ...
                          <a href="https://stripe.com/privacy" target="_blank" className="text-blue-600 hover:underline">
                                Privacy Policy
                            </a> 
                        </li>
                        <li>  
                          <strong> PayPal: </strong> 
                          <a href="https://www.paypal.com/us/legalhub/paypal/privacy-full" target="_blank" className="text-blue-600 hover:underline">
                                Privacy Policy  
                            </a>
                        </li>
                      </ul>
                    <p>
                    Please note that our third-party payment processors' use of your personal information is governed by their respective Privacy Policies.
                    </p>
                  </ul>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="behavioral-remarketing">
                ...
                <AccordionContent>
                  <div className="space-y-6">
                    <section>
                      <h3 className="font-large font-bold">Overview</h3>
                      <p>
                    ...
                    <section>
                      <h3 className="font-large font-bold">How It Works</h3>
                      <p>
                    ...
                    <section>
                      <h3 className="font-large font-bold">Non-Cookie Technologies and Opt-Out</h3>
                      <p>
                    ...
                    <section>
                      <h3 className="font-large font-bold">Mobile Device Opt-Out</h3>
                      <p>
                    ...
                    <section>
                      <h3 className="font-large font-bold">Information Sharing</h3>
                      <p>
                    ...
                    <section>
                      <h3 className="font-large font-bold">Third-Party Vendors</h3>
