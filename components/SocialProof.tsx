      ...
      <div className="container mx-auto px-4 text-center">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-green-500/10 text-green-500 px-4 py-2 rounded-full">95% Match Rate</div>
            <div className="bg-purple-500/10 text-purple-500 px-4 py-2 rounded-full">4.9/5.0 Rating</div>
          </div>
        </div>
