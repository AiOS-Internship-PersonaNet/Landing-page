  ...
  const FEATURES = [
    {
      ...
      description: 'Create distinct AI Personas for different life aspects like work or hobbies.',
    ...
    },
    {
      ...
      description: 'A new, easy, and fun social media platform.',
    ...
    },
    {
      ...
      description: 'Helps in refining marketing and communication strategies based on user interactions and preferences.',
      img: '/images/chat.png',
    ...
    },
    {
      ...
      description: `Enables a more genuine self-representation, free from common social media issues.`,
      ...
      <div className="benefits-container">
        ...
        <ul className="features-list">
          {FEATURES.map((feature, index) => {
            ...
            return (
              <motion.li key={index} className="feature-item" animate={controls} initial="hidden" whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}>
