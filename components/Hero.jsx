    ...
    <section className="min-h-screen flex items-center justify-center pt-20 pb-20 bg-black">
      <div className="container mx-auto px-4 text-center">
        ...
        <h2 className="text-2xl md:text-3xl text-gray-300 mb-12">
          Your SuperIntro Meets People for You—So You Only Invest in Real
          Connections
        </h2>
        <div className="max-w-2xl mx-auto mb-12">
          <ul className="space-y-6 text-left">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-gray-400">
                  Every swipe, ghosted message, and dead-end conversation drains
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <span className="block text-xl font-semibold text-pink-400 mb-1">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <span className="block text-xl font-semibold text-orange-400 mb-1">
                  Real Connections, Less Effort
                </span>
                <span className="text-gray-400">
                  Stop investing hours of emotional labor just to end up feeling
                  drained, discouraged, and disconnected.
                </span>
              </div>
            </li>
          </ul>
