    ...
    <section className="py-20 bg-black border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-4">Less Small Talk. More Real Connections. Zero Wasted Time.</p>
          <p className="text-gray-400">
            Tired of forced, awkward meetups? SuperIntro simulates conversations between your digital self and others—so
            by the time you meet in real life, the chemistry is already there.
          </p>
        </div>
