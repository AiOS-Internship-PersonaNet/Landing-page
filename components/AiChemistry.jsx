  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl text-gray-300 font-bold text-center mb-12">
        ...
        <div className="text-center mt-12">
          <p className="text-xl font-semibold mb-4">
            ✅ A 95% show-up rate—because people don't flake when they already
            feel a connection.
          </p>
          <p className="text-xl font-semibold mb-4">
            ✅ An 89% match success rate—because compatibility isn't left to
            chance.
          </p>
          <p className="text-xl font-semibold mb-8">
            ✅ No randomness, no networking gimmicks—just meaningful
            interactions.
          </p>
