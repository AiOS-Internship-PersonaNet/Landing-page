...
const steps = [
  {
    ...
    number: "1",
    title: "Define",
    description: "Answer a few quick questions about your personality, goals, and social style.",
  },
  {
    icon: MessageSquare,
    number: "2",
    title: "Connect",
    description: "Your SuperIntro simulates conversations with others—learning who you actually enjoy talking to.",
  },
  {
    icon: Utensils,
    number: "3",
    title: "Dine",
    description: "Book a small-group dinner with five compatible people you've already vibed with in AI simulations.",
  },
  {
    icon: Users,
    number: "4",
    title: "Meet",
    description: "Skip the awkward intros—walk into an event where you already know it's going to be a great time.",
  },
]
    ...
    <section className="py-20 bg-black border-t border-gray-800">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-center text-gray-400 mb-16 max-w-2xl mx-auto">
          Meet People You Already Click With—Not Just People Who Look Good on Paper
        </p>
