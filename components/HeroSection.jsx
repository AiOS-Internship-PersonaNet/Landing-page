...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      className="flex flex-col items-center justify-center h-screen w-full  hover:from-blue-600 hover:to-teal-600 text-white font-medium py-2.5 px-5 rounded-lg  transition relative"
    >
      <div
        className="absolute top-0 left-0 w-full h-full bg-cover bg-center flex items-end justify-center"
        style={{
          background:
            "radial-gradient(circle at 0% 0%, #220138, #2b0399, #220138)",
